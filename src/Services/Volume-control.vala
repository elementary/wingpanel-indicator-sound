...
public class Sound.Services.VolumeControl : Object {
    ...
    void reconnect_to_pulse () {
        ...
        props.sets (PulseAudio.Proplist.PROP_APPLICATION_ID, "wingpanel.settings.sound");
    ...
    private void sink_info_set_volume_cb (PulseAudio.Context c, PulseAudio.SinkInfo? i, int eol) {
        ...
        unowned PulseAudio.CVolume cvol = vol_set (i.volume, 1, double_to_volume (_volume));
